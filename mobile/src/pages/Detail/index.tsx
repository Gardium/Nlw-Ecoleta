...
import{Linking,View,Text,Image, StyleSheet, TouchableOpacity, SafeAreaView} from 'react-native'
...
function handleWhatsapp(){
  Linking.openURL(`whatsapp://send?phone=+55${(data.point.whatsapp.replace('(','').replace(')','').replace('-',''))}&text= Olá, tenho interesse sobre coleta de resíduos `)
